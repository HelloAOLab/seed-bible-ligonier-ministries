...
const AddNewPlaylist = ({
    ...
    const listPlaylist = useMemo(() => {
        if (renameScreen) {
            return globalThis[`${id}playlists`].find(ele => ele.id === editId)?.list || [];
        }
        return list;
    }, [list, editId])
        ...
        <div className="add-new-playlist" style={{ border: 'none' }}>
            <div className="align-center justify-between" style={{ padding: '0.5rem 0 ', justifyContent: 'space-between' }}>
                <div className='back-button' onClick={() => {
                    ...
                    <span>
                        Back to {editId ? "Discover" : "Create"}
                    </span>
                </div>
            </div>
            <h3>Enter the details below to {editId ? "update" : "save"}.</h3>
            <p style={{ color: "#606060", margin: '8px 0' }}>These details are mandatory for the playlist metadata.</p>
                ...
                <div style={{ width: 'auto' }}>
                    ...
                    >
                        <div
                            ...
                            type="image/*"
                            type="file"
                            style={{ position: 'absolute', zIndex: '9', borderRadius: '50%', top: '0', left: '0', width: '100%', height: '100%', opacity: '0' }}
                        />
                        <RenderIcon
                ...
                <Button
                    onClick={() => {
                        ...
                        const checkNameDuplicate = (newName) => {
                            ...
                            const names = (globalThis[`${id}playlists`] || []).map((ele) => {
