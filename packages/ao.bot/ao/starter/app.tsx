            ...
            if (typeof ai !== "undefined" && ai.chat) {
                ...
                const labelForSeedBibleDevURL = (raw) => {
                    try {
                        ...
                        if (!pattern || pattern.toLowerCase() !== "seedbibledev") return null;
                        ...
                        if (bookLabel && chapLabel) {
                            main = `${bookLabel} ${chapLabel}${verseLabel ? `:${verseLabel}` : ""}`;
                        } else if (trLabel && !bookLabel) {
                            main = `Seed Bible — ${trLabel}`;
                        }

                        const suffix = trLabel && (bookLabel || verseLabel || chapLabel) ? ` (${trLabel})` : "";
                        return `${main}${suffix}`;
                    } catch {
                        return null;
                    }
                ...
                if (lowerMessage.includes("seed bible") || lowerMessage.includes("what is")) {
                    botResponse =
                ...
                } else if (lowerMessage.includes("use") || lowerMessage.includes("how")) {
                    botResponse =
                ...
                } else if (lowerMessage.includes("feature") || lowerMessage.includes("reader")) {
                    botResponse =
                ...
                } else if (lowerMessage.includes("session") || lowerMessage.includes("group")) {
                    botResponse =
                ...
                } else if (lowerMessage.includes("plan") || lowerMessage.includes("reading plan")) {
                    botResponse =
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <p style={{ fontSize: "14px", color: "#999", marginBottom: "32px", lineHeight: 1.6 }}>
                        Enter the session code shared by your group leader to join a collaborative Bible study session.
                    </p>
                    ...
                    <div style={{ marginBottom: "24px" }}>
                        ...
                        <input
                            ...
                            onKeyDown={(e) => {
                                if (e.key === "Enter" && sessionCode.trim().length >= 6) handleJoinSession();
                            }}
                        />
                    </div>
                    ...
                    <button
                        ...
                        style={{
                            width: "100%",
                            padding: "16px",
                            backgroundColor: sessionCode.trim().length >= 6 ? "#e67e50" : "#3a3a3a",
                            border: "none",
                            borderRadius: "10px",
                        ...
                        onMouseLeave={(e) => {
                            ...
                            if (sessionCode.trim().length >= 6) e.currentTarget.style.backgroundColor = "#e67e50";
                        }}
                    >
                        Join Session
                    </button>
                ...
                <div style={{ marginTop: "40px", maxWidth: "500px", textAlign: "center" }}>
                    ...
                    >
                        ...
                        >
                            ...
                            <div style={{ fontWeight: "500", color: "#ccc", marginBottom: "4px" }}>Collaborate</div>
                            <div style={{ fontSize: "12px" }}>Study together in real-time</div>
                        </div>
                        <div
                            style={{
                                padding: "16px",
                        ...
                        >
                            <div style={{ fontSize: "24px", marginBottom: "8px" }}>💬</div>
                            <div style={{ fontWeight: "500", color: "#ccc", marginBottom: "4px" }}>Share Insights</div>
                        ...
                        >
                            <div style={{ fontSize: "24px", marginBottom: "8px" }}>📖</div>
                            <div style={{ fontWeight: "500", color: "#ccc", marginBottom: "4px" }}>Sync Reading</div>
    ...
    if (currentView === "home") {
        return (
            ...
            >
                ...
                <div style={{ display: "flex", gap: "20px", marginBottom: "130px", flexWrap: "wrap", 'margin-left': '60px', justifyContent: "center" }}>
                    <button
                        onClick={() => {
                            os.goToURL(`https://ao.bot/?pattern=SeedBibleDev&noGridPortal=true`);
                        }}
                        style={{
                            width: "240px",
                            height: "146px",
                    ...
                    >
                        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                            ...
                            <div style={{ position: "absolute", top: "20px", right: "20px", fontSize: "18px" }}>↗</div>
                        </div>
                        <div style={{ fontSize: "16px", fontWeight: "600", color: "#1a1a1a", textAlign: "left" }}>
                            Launch Seed Bible
                        </div>
                    </button>

                    <div>
                        <div style={{ width: "500px", maxWidth: "90%", marginBottom: "14px" }}>
                            <button
                                style={{
                                    width: "100%",
                                    backgroundColor: "#2a2a2a",
                            ...
                            >
                                ...
                                <div style={{ fontSize: "15px", color: "#ffffff", textAlign: "left" }}>Join Session</div>
                            </button>
                        </div>
                        <div style={{ width: "500px", maxWidth: "90%", marginBottom: "0" }}>
                            ...
                            >
                                ...
                                <div style={{ fontSize: "15px", color: "#ffffff", textAlign: "left" }}>Build with seed bible</div>
                            </button>
                        </div>
                ...
                <div style={{ display: "flex", gap: "20px", marginBottom: "40px", flexWrap: "wrap", justifyContent: "center" }}>
                    {["What is seed bible?", "How can I use it?", "What features does it have?"].map((text, idx) => (
                        <button
                            key={idx}
                ...
                <div style={{ width: "718px", height: '123px', maxWidth: "90%", position: "relative" }}>
                    <input
                        type="text"
                        placeholder="Ask..."
                        value={inputValue}
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <span style={{ marginLeft: "auto", opacity: 0.7, fontSize: "12px" }}>⌘ + K</span>
                </button>
                ...
                <div style={{ flex: 1, overflowY: "auto", padding: "0 10px" }}>
                    ...
                    <div style={{ fontSize: "12px", color: "#666", padding: "12px 16px", fontWeight: "600" }}>
                        CHAT HISTORY
                    </div>
