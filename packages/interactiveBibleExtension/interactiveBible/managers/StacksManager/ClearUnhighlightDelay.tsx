/**
    ...
    * @param {Number} that.unhighlightDelayInfoIndex - The index of the instance of UnhighlightDelayInfo in StacksManager.vars.unhighlightDelaysInfo
    * @example
    * StacksManager.ClearUnhighlightDelay({unhighlightDelayInfo: someUnhighlightDelayInfo, unhighlightDelayInfoIndex: someUnhighlightDelayInfoIndex});
*/
