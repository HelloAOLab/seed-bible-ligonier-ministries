...
const {name} = that;
const arrangement = InstanceManager.vars.fixedArrangementsInfo.find((currentArrangement) => {return currentArrangement.name == name});
if(arrangement)
{
    const index = InstanceManager.vars.fixedArrangementsInfo.indexOf(arrangement);
