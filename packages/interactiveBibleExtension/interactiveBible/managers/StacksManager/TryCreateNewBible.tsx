 ...
 * 
 * @example
 * StacksManager.TryCreateNewBible({buttonId: 0, position: new Vector2(0, 0), modality: "mouse"});
 */

const {buttonId, position, modality} = that;
if(thisBot.masks.isBibleCreationActive && ((modality === ClickModality.mouse && buttonId === MouseButtonId.left) || modality === ClickModality.touch) && !thisBot.masks.isBibleAnimating)
{
