...
const bookNameLabelsPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.label"),
    customTags: [
...
const bookDateLabelsPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.bookDateLabel"),
    customTags: [
...
const linesPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.line"),
    customTags: [
...
const toggleButtonsPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.toggle"),
    customTags: [
...
const toggleBackgroundsPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.toggleBackground"),
    customTags: [
...
const toggleHandlesPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.toggleHandle"),
    customTags: [
...
const buttonsPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.button"),
    customTags: [
...
const buttonIconsPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.buttonIcon"),
    customTags: [
...
const buttonLabelsPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.buttonLabel"),
    customTags: [
...
const colorPickerBackgroundsPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.colorPickerBackground"),
    customTags: [
...
const colorPickerContentsPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.colorPickerContent"),
    customTags: [
...
const settingsButtonsPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.settingsButton"),
    customTags: [
...
const bookInfoCardTransformer = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.bookInfoCardTransformer"),
    customTags: [
...
const bookInfoCardBackground = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.bookInfoCardBackground"),
    customTags: [
...
const bookInfoCardContent = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.bookInfoCardContent"),
    customTags: [
...
const chapterPlaylistEntryItemPool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.chapterPlaylistEntryItem"),
    customTags: [
...
const playlistNavigationButton = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.playlistNavigationButton"),
    customTags: [
...
const chapterPlaylistEntryNodePool = new PoolData({
    ...
    bot: getBot("system", "bibleLayout3D.prefabs.chapterPlaylistEntryItemNode"),
    customTags: [
