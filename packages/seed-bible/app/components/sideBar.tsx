    ...
    const handleTabClick = () => {
        ...
        if (el.data.type === "book" && checkEmpty) {
            ...
            ReplaceApplication(checkEmpty.id,
                { id: id, App: <ThePageWithEditor tab={el} panelId={id} preferTab={true} />, to: 'panel', minWidth: '30rem' })
            return
            ...
            ReplaceApplication(checkEmpty && checkEmpty.id || PanelsApps[0].id,
                { id: id, App: <App tab={tabData} panelId={id} activeTab={el.id} />, to: 'panel', minWidth: '30rem' })
            return
        }
