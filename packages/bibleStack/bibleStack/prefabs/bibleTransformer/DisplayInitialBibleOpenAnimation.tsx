...
await Promise.all(animations)
    .then(() => {
        ...
        setTagMask([bibleData.staticBibleElements.crossVerticalLine, bibleData.staticBibleElements.crossHorizontalLine], "pointable", bibleData.bibleType === BibleVizUtils.Data.tags.BibleType.Default);
