...
const upperCover = ObjectPooler.GetObjectFromPool({tag: BibleVizUtils.Data.tags.ObjectPoolTags.Cover});
const upperCoverMod = {stackBibleId: bibleData.id};
const leftCover = ObjectPooler.GetObjectFromPool({tag: BibleVizUtils.Data.tags.ObjectPoolTags.Cover});
const leftCoverMod = {stackBibleId: bibleData.id};
const lowerCover = ObjectPooler.GetObjectFromPool({tag: BibleVizUtils.Data.tags.ObjectPoolTags.Cover});
const lowerCoverMod = {stackBibleId: bibleData.id};
const crossVerticalLine = ObjectPooler.GetObjectFromPool({tag: BibleVizUtils.Data.tags.ObjectPoolTags.CrossLine});
const crossVerticalLineMod = {stackBibleId: bibleData.id};
const crossHorizontalLine = ObjectPooler.GetObjectFromPool({tag: BibleVizUtils.Data.tags.ObjectPoolTags.CrossLine});
const crossHorizontalLineMod = {stackBibleId: bibleData.id};
const bibleShadow = ObjectPooler.GetObjectFromPool({tag: BibleVizUtils.Data.tags.ObjectPoolTags.BibleShadow});
