...
if(data.isSelected)
{
    ...
    const chapterColumns = Math.floor((isSectionBookDataInstance ? data.element.tags.initialScaleX : data.element.tags.singleBooksScales.x) / (BibleVizUtils.
Data.ChapterWidth + (StackSpacing.ChapterGap*2)))
