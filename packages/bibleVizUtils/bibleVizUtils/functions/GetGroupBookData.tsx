...
groupBookScaleX = (BibleVizUtils.Data.tags.StackElementMeasurements.BookScales.x * (bookLayout.x.to - bookLayout.x.from));
...
if(bookLayout.x.from === 0 && bookLayout.x.to !== 1)
{
    ...
    groupBookLayoutPositionX = (groupBookScaleX / 2) - (BibleVizUtils.Data.tags.StackElementMeasurements.BookScales.x / 2);
    groupBookPositionX += groupBookLayoutPositionX;
}
else if(bookLayout.x.from !== 0 && bookLayout.x.to === 1)
{
    groupBookScaleX -= (BibleVizUtils.Data.tags.StackSpacing.BetweenBooks / 2);
    groupBookLayoutPositionX = (BibleVizUtils.Data.tags.StackElementMeasurements.BookScales.x / 2) - (groupBookScaleX / 2)
    groupBookPositionX += groupBookLayoutPositionX;
}
else
{
...
groupBookScaleY = (BibleVizUtils.Data.tags.StackElementMeasurements.BookScales.y * (bookLayout.y.to - bookLayout.y.from));
...
if(bookLayout.y.from === 0 && bookLayout.y.to !== 1)
{
    ...
    groupBookLayoutPositionY = (groupBookScaleY / 2) - (BibleVizUtils.Data.tags.StackElementMeasurements.BookScales.y / 2)
    groupBookPositionY += groupBookLayoutPositionY;
}
else if(bookLayout.y.from !== 0 && bookLayout.y.to === 1)
{
    groupBookScaleY -= (BibleVizUtils.Data.tags.StackSpacing.BetweenBooks / 2);
    groupBookLayoutPositionY = (BibleVizUtils.Data.tags.StackElementMeasurements.BookScales.y / 2) - (groupBookScaleY / 2)
    groupBookPositionY += groupBookLayoutPositionY;
}
else
{
