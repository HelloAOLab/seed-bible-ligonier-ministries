...
const mapCoversPool = new PoolData({
    ...
    customTags: [
        ...
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutCover}),
        new CustomTag({name: "system", value: null}),
    ],
    size: 1
})
const mapBooksPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutBook}),
        new CustomTag({name: "typeOfElement", value: BibleElementType.LayoutBook}),
...
const mapBookNameLabelsPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutBookNameLabel}),
        new CustomTag({name: "system", value: null}),
    ],
    size: 70
})
const mapBookDateLabelsPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutBookDateLabel}),
        new CustomTag({name: "system", value: null}),
    ],
    size: 70
})
const mapLinesPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutLine}),
        new CustomTag({name: "system", value: null}),
    ],
    size: 17
})
const mapLabelsPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutLabel}),
        new CustomTag({name: "system", value: null}),
    ],
    size: 6
})
const mapChaptersPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutChapter}),
        new CustomTag({name: "typeOfElement", value: BibleElementType.LayoutChapter}),
...
const mapToggleButtonsPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutToggleButton}),
        new CustomTag({name: "system", value: null})
    ],
    size: 3
})
const mapToggleBackgroundsPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutToggleBackground}),
        new CustomTag({name: "system", value: null})
    ],
    size: 3
})
const mapToggleHandlesPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutToggleHandle}),
        new CustomTag({name: "system", value: null})
    ],
    size: 3
})
const mapButtonsPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutButton}),
        new CustomTag({name: "system", value: null})
    ],
    size: 2
})
const mapButtonIconsPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutButtonIcon}),
        new CustomTag({name: "system", value: null})
    ],
    size: 1
})
const mapButtonLabelsPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutButtonLabel}),
        new CustomTag({name: "system", value: null})
    ],
    size: 1
})
const mapColorPickerBackgroundsPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutColorPickerBackground}),
        new CustomTag({name: "system", value: null})
    ],
    size: 1
})
const mapColorPickerContentsPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutColorPickerContent}),
        new CustomTag({name: "system", value: null})
    ],
    size: 1
})
const mapSettingsButtonsPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutSettingsButton}),
        new CustomTag({name: "system", value: null})
    ],
    size: 1
})
...
const mapBookInfoCardTransformer = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutBookInfoCardTransformer}),
        new CustomTag({name: "system", value: null})
    ],
    size: 1
})
const mapBookInfoCardBackground = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutBookInfoCardBackground}),
        new CustomTag({name: "system", value: null})
    ],
    size: 1
})
const mapBookInfoCardContent = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutBookInfoCardContent}),
        new CustomTag({name: "system", value: null})
    ],
    size: 1
})
...
const mapChapterPlaylistEntryItemPool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutChapterPlaylistEntryItem}),
        new CustomTag({name: "system", value: null})
    ],
    size: 1
})
...
const mapChapterPlaylistEntryNodePool = new PoolData({
    ...
    customTags: [
        new CustomTag({name: "poolTag", value: ObjectPoolTags.LayoutChapterPlaylistEntryNode}),
        new CustomTag({name: "system", value: null}),
    ],
    size: 1
})
