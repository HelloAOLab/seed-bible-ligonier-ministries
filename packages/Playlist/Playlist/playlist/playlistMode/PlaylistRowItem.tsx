        ...
        <>
            ...
            >
                ...
                <div style={{ height: id === opendedList ? "auto" : '0', transition: "all 0.2s linear", overflow: 'hidden', padding: "0 10px", zIndex: '1' }}>
                    ...
                    {list?.length === 0 && <h4 style={{ margin: "8px 0" }} >No items yet, add something below.</h4>}
                    {
                        opendedList
                        &&
