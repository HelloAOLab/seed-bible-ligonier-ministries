...
const AutoplayIcons = {
    "FALSE": "https://auth-aux-aobot-prod-filesbucket-141297942820.s3.amazonaws.com/aoBot/ef49fd6fb22cd50cb67463c2ddaee79e9076b2e228a6ec35802e5a1fac666c8f.svg",
    ...
    return <>
            ...
            onClick={(e) => {
                ...
                if (data.additionalInfo.type === "playlist") {
                    if (!isPlaylistNestedPlayAble) {
                        return ShowNotification({ message: "Cannnot Play Playlist While annotating!", severity: "error" });
                    } else {
        ...
        >
            ...
            <div className="actions">
                ...
                {
                    editAbleTypes[data.additionalInfo.type] && creatingPlaylist && !viewOnly && <p className={`end-icon without-right-margin ${`${isMobile && "visible"}`}`} onClick={(e) => {
                        e.stopPropagation();
                ...
                {!playingPlaylist && !!onDisembed && layers && creatingPlaylist && !viewOnly && <p className={`end-icon without-right-margin ${`${isMobile && "visible"}`}`}
                    onClick={(e) => {
                        e.stopPropagation();
                        if (onDisembed) {
                            onDisembed();
